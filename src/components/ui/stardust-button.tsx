...
export const StardustButton = ({ 
  ...
  const buttonStyle = {
    ...
    boxShadow: `
      ...
      inset 0 -0.4rem 0.9rem rgba(16, 185, 129, 0.5),
  ...
  const pStyle = {
    ...
    maskImage: 'linear-gradient(to bottom, rgba(16, 185, 129, 1) 40%, transparent)',
  };
  ...
  const beforeAfterStyles = `
    ...
    .pearl-button .wrap::after {
      ...
      box-shadow: inset 0 10px 8px -10px rgba(52, 211, 153, 0.6);
    ...
    .pearl-button:active {
      ...
      box-shadow:
        inset 0 0.3rem 0.5rem rgba(52, 211, 153, 0.5),
        inset 0 -0.1rem 0.3rem rgba(0, 0, 0, 0.8),
        inset 0 -0.4rem 0.9rem rgba(16, 185, 129, 0.4),
        0 3rem 3rem rgba(0, 0, 0, 0.3),
        0 1rem 1rem -0.6rem rgba(0, 0, 0, 0.8);
    }
  `;
